      ...
      <div className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="flex flex-col">
            <span className="text-[9px] font-bold text-slate-400 uppercase tracking-tight">Net RR</span>
        ...
        {info.grossRr !== undefined && info.commission !== undefined && info.commission > 0 && (
          <div className="bg-slate-50 border border-slate-100 rounded-xl px-3 py-2 flex items-center justify-between text-[10px]">
            <div className="flex flex-col">
              <span className="text-[8px] text-slate-400 uppercase font-bold">Gross</span>
            ...
            <div className="flex flex-col items-end">
              <span className="text-[8px] text-slate-400 uppercase font-bold">Net</span>
