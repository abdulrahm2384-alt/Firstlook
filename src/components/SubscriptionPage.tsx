  ...
  const planCards = [
    {
      ...
      features: [
        ...
        { text: 'Multi-Symbol Watchlist (Max 3 Pairs)', included: true },
        { text: 'Historical News Stream', included: true },
        { text: 'Time Sync Playing', included: false },
        { text: 'Simulated Competitions', included: false },
        { text: 'Create/Edit Indicator Script', included: false },
        { text: 'Replay Historic Trades', included: false },
    ...
    },
    {
      ...
      features: [
        { text: 'Complete Indicator Toolsets', included: true },
        { text: 'Interactive Drawing Tools', included: true },
        { text: 'Multi-Symbol Watchlist', included: true },
        { text: 'Historical News Stream', included: true },
        { text: 'Time Sync Playing', included: true },
        { text: 'Create/Edit Indicator Script', included: true },
        { text: 'Replay Historic Trades', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Customizable Forex Spreads (Disable option)', included: true },
        { text: 'Invite multiple user slots to account', included: true },
      ],
