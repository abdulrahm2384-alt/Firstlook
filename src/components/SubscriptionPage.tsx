  ...
  const planCards = [
    {
      ...
      features: [
        ...
        { text: 'Daily Candle Playback (Max 1,000 candles)', included: true },
        { text: 'Daily Journal Replay Trades (Max 5 a day)', included: true },
        { text: 'Daily Synced Charts (Max 3 features a day)', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Daily Candle Playback (Max 7,000 candles)', included: true },
